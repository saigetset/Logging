...
public class JdbcSelectApp {
	...
	static {
		  ...
		  SimpleLayout layout = new SimpleLayout(); ConsoleAppender appender = new
		  ConsoleAppender(layout);
		 
		/*
		 * HTMLLayout layout = new HTMLLayout(); FileAppender appender = null; try {
		 * appender = new FileAppender(layout, "log.html"); } catch (IOException e) {
		 * e.printStackTrace(); }
		 */
		
		logger.addAppender(appender);
		logger.setLevel(Level.DEBUG);
		logger.debug("JdbcSelectApp.class file is loading.....");
	}
